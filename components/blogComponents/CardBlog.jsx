...
function CardBlog() {
  ...
  return (
    <div
      className="mt-[100px] relative mb-12 p-[1px] bg-[#1C5DE9] lg:bg-[white] sm:bg-[#1C5DE9] md:bg-[#1C5DE9] lg:bg-none rounded-[24px] sm:rounded-[24px] md:rounded-[48px] lg:rounded-[48px] sm:pb-[0px] md:pb-[0px] lg:pt-[40px] "
      style={{
