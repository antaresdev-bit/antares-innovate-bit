...
const ConditionalTextMarketing = ({ title, subtitle, gradient, circleColor, iconSrc }) => {
  return (
    <div className="sm:block md:hidden lg:hidden mt-[100px] mb-[120px]">
      ...
      <div className="flex items-center mt-[10px]">
        <div
          className="w-[55px] h-[55px] min-w-[55px] min-h-[55px] rounded-full flex items-center justify-center mb-[40px]"
