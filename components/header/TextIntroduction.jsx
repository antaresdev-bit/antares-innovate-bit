        ...
        <div className="text-[25px] sm:text-[25px] md:text-[25px] lg:text-[30px] mt-[28px] sm:mt-[28px] md:mt-[30px] lg:mt-[57px] sm:ml-[22px] md:ml-[53px] lg:ml-[53px]">
          <p
            className="ml-[21px] sm:ml-[21px] md:ml-[0px] lg:ml-[0px] font-extrabold text-white 
             leading-[31px] sm:leading-[31px] md:leading-[40px] lg:leading-[45px] tracking-tight
          ...
          >
            ...
            negocios con estrategias digitales innovadoras que combinan
            inteligencia artificial, automatización y diseño disruptivo,
            ayudando a marcas visionarias a liderar en el mundo digital. Si tu
            objetivo es crecer y evolucionar, estamos aquí para hacerlo posible.
          </p>

          <div className="flex items-center text-left  mt-[49px] ml-[21px] sm:ml-[21px] md:ml-[0px] lg:ml-[0px] ">
